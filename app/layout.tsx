...
export const metadata: Metadata = {
  ...
  title: "Kauan Cerqueira | Páginas que Geram Contato no WhatsApp",
  description:
    "Criação de páginas profissionais para negócios locais. Páginas diretas, com visual limpo e estrutura pensada para transformar visitantes em conversas no WhatsApp. Orçamento sob medida.",
  generator: "Next.js",
  keywords: [
    "página para gerar contato",
    "criação de páginas",
    "página de vendas",
    "página para WhatsApp",
  ...
  twitter: {
    ...
    title: "Kauan Cerqueira | Páginas que Geram Contato",
    description:
