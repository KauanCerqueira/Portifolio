        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              A pagina nao existe para impressionar so pelo design. Ela existe
              para passar seguranca e facilitar o contato.
            </p>

            <div className="flex flex-wrap gap-3">
              {["sem excesso", "sem enrolacao", "sem agencia", "sem processo longo"].map(
                (pill, index) => (
                  <span
                    key={pill}
