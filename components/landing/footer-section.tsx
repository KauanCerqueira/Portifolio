...
import { brand, footerLinks, whatsappHref } from "@/lib/landing-content";
          ...
          <div className="grid lg:grid-cols-[1.4fr_1fr_1fr] gap-12 lg:gap-8">
            <div>
              <a href="#" className="inline-flex items-center gap-3 mb-6">
                <img src="/k-logo.svg" alt={`${brand.name} logo`} className="w-12 h-12 rounded-md" />
                <div>
            ...
            <div>
              <h3 className="text-sm font-medium mb-6">Navegacao</h3>
            ...
            <div>
              <h3 className="text-sm font-medium mb-6">Oferta</h3>
              <ul className="space-y-4 text-sm text-muted-foreground">
                <li>Landing page pensada para conversao</li>
        ...
        <div className="py-8 border-t border-foreground/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <span className="flex items-center gap-2">
              ...
              Landing pronta para receber prova real
            </span>
          </div>
        </div>
      </div>
