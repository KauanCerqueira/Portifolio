...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-[#040404] text-white">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(52%_46%_at_76%_30%,rgba(255,255,255,0.08),transparent_56%)]" />
        <div className="absolute inset-x-0 bottom-0 h-px bg-white/14" />
      </div>
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto w-full px-6 lg:px-12 py-30 lg:py-36">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/62">
            <span className="w-8 h-px bg-white/28" />
            {heroContent.kicker}
          </span>
        </div>
        ...
        <div className="mb-8 max-w-[1040px]">
          <h1
            className="text-[clamp(3rem,6.2vw,5.85rem)] font-display leading-[0.94] tracking-tight text-white"
          >
        ...
        <div className="max-w-[32rem]">
          <p
            className={`text-[1.05rem] lg:text-[1.18rem] text-white/78 leading-relaxed transition-all duration-700 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
          ...
          >
            <Button
              asChild
              size="lg"
              className="bg-white hover:bg-white/88 text-black px-8 h-14 text-base rounded-full group shadow-[0_18px_40px_rgba(0,0,0,0.3)]"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="h-14 px-8 text-base rounded-full border-white/18 bg-white/[0.04] text-white hover:bg-white/[0.10] hover:text-white"
            >
          ...
          <div
            className={`mt-7 inline-flex items-center gap-3 text-[11px] uppercase tracking-[0.22em] font-mono text-white/60 transition-all duration-700 delay-500 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
            <span className="w-2 h-2 rounded-full bg-white/58 animate-pulse" />
            Mais contato no WhatsApp
          </div>
        </div>
              ...
              <div key={setIndex} className="hero-marquee-group">
                {heroHighlights.map((highlight) => (
                  <div key={`${highlight}-${setIndex}`} className="flex items-baseline gap-3">
                    <span className="text-2xl lg:text-3xl font-display text-white/72">+</span>
                    <span className="text-xs lg:text-sm text-white/68">
                      {highlight}
                      <span className="block font-mono text-[10px] lg:text-xs mt-1 text-white/34">
                        estrutura direta
                      </span>
                    </span>
                  </div>
