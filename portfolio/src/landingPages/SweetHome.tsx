...
const SweetHome: React.FC = () => {
  ...
  const [stickyBarClosed, setStickyBarClosed] = useState<boolean>(false)
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (window.scrollY > 300 && !stickyBarClosed) {
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content:
        "A SweetHome transformou nosso terreno em um lar dos sonhos! A atenção aos detalhes e o cumprimento de prazos nos surpreenderam. Superou todas as expectativas!",
      rating: 5,
    ...
    },
    {
      ...
      location: "Jardins, SP",
      content:
        "Reforma impecável! Em 60 dias meu apartamento estava completamente transformado. Equipe profissional, materiais de primeira qualidade. Recomendo de olhos fechados!",
      rating: 5,
    ...
    },
    {
      ...
      location: "Moema, SP",
      content:
        "Parcelamento facilitado e projeto personalizado tornaram possível nossa cozinha gourmet. A SweetHome entendeu exatamente o que queríamos. Gratidão total!",
      rating: 5,
  ...
  const openWhatsApp = (message = ""): void => {
  ...
  return (
    <div className="bg-stone-50 font-['Poppins',_system-ui,_sans-serif]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-700 mb-8 leading-relaxed">
                Transformamos sonhos em realidade com projetos personalizados, materiais de qualidade e equipe
                especializada. Sua casa perfeita está a um clique de distância.
              </p>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${benefit.gradient} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}
                >
                  {benefit.icon}
                </div>
                ...
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="min-w-full px-4">
                    <div className="bg-white rounded-[3rem] p-12 shadow-2xl border-4 border-amber-100 relative">
                      ...
                      <p className="text-xl text-gray-700 leading-relaxed mb-6 italic">"{testimonial.content}"</p>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-stone-900 via-amber-900 to-orange-900 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <p className="text-2xl text-amber-100 mb-12 max-w-3xl mx-auto leading-relaxed">
            Fale conosco agora e receba um orçamento personalizado gratuito. Vamos transformar sua casa juntos!
          </p>
      ...
      <div className="fixed bottom-6 right-6 z-50 group">
        <button
          onClick={() => openWhatsApp()}
          className="relative bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white p-5 rounded-full shadow-2xl transition-all hover:scale-110 animate-pulse"
        >
        ...
        <div className="hidden lg:block absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-gradient-to-r from-green-600 to-green-700 text-white px-4 py-2 rounded-xl font-bold text-sm whitespace-nowrap shadow-xl">
          Solicitar Orçamento
        </div>
      </div>
      ...
      >
        <div className="bg-gradient-to-r from-stone-900 via-stone-800 to-stone-900 border-t-4 border-amber-500 shadow-2xl">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="hidden md:flex w-12 h-12 bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl items-center justify-center flex-shrink-0">
                  <Home className="w-6 h-6 text-white" />
                </div>
                <div>
                  <div className="text-white font-bold text-lg leading-tight">Pronto para começar seu projeto?</div>
                  <div className="text-amber-300 text-sm">Orçamento grátis • Resposta em 24h</div>
                </div>
              </div>

              <div className="flex items-center gap-3">
                <button
                  onClick={() => openWhatsApp("Olá! Quero solicitar um orçamento para meu projeto!")}
                  className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-bold py-3 px-6 rounded-xl flex items-center gap-2 transition-all hover:scale-105 shadow-lg"
                >
                  <MessageCircle className="w-5 h-5" />
                ...
                <button
                  onClick={() => setStickyBarClosed(true)}
                  className="w-10 h-10 flex items-center justify-center text-stone-400 hover:text-white hover:bg-stone-700 rounded-lg transition-all"
                  aria-label="Fechar"
                >
                  <X className="w-5 h-5" />
                </button>
      ...
      <div className="fixed bottom-24 right-6 z-40 animate-bounce">
        <div className="bg-gradient-to-r from-amber-500 to-orange-600 text-white px-4 py-2 rounded-2xl shadow-xl text-sm font-bold">
          Orçamento Grátis
        </div>
      </div>
    </div>
